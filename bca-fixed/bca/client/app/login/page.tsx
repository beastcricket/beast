...
// NO Admin card here — admin uses hidden URL /bca-admin-x7k2/login
const ROLES = [
  { id:'organizer',  icon:'🎬', label:'Organizer',  color:'from-amber-500/30 to-yellow-600/10', tagline:'Command Center Access', path:'/dashboard/organizer' },
  { id:'team_owner', icon:'🏆', label:'Team Owner', color:'from-blue-500/30 to-cyan-600/10',   tagline:'War Room Access',       path:'/dashboard/team-owner' },
        ...
        <div className="bg-glass-premium rounded-xl p-7 gold-edge opacity-0 animate-slide-up" style={{ animationDelay:'0.2s' }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
            ...
            <div>
              ...
              <div className="text-right mt-1"><Link href="/forgot-password" className="text-[11px] font-heading text-primary hover:underline">Forgot password?</Link></div>
            </div>
          ...
          <div className="mt-5 pt-4 border-t border-border">
            <p className="text-center text-sm text-muted-foreground">No account? <Link href="/register" className="text-primary hover:underline font-medium">Register free</Link></p>
          </div>
        </div>
      </div>
    </div>
